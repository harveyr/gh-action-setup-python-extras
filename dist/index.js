...
function getMatcherPath(matcherFileName) {
...
exports.getMatcherPath = getMatcherPath;
function getMatchersPaths() {
    return fs.readdirSync(MATCHERS_PATH).map(getMatcherPath);
}
exports.getMatchersPaths = getMatchersPaths;
...
function loadMatcherData(fpath) {
    return JSON.parse(fs.readFileSync(fpath).toString('utf8'));
}
exports.loadMatcherData = loadMatcherData;
